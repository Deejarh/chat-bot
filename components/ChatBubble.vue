...
<template>
  ...
  >
    ...
    <div v-if="isDeejarBot"
      class="chat-bubble py-0 prose prose-sm  bg-blue-100 dark:bg-gray-700  dark:text-gray-200 text-black max-w-max w-full"
    ...
    <div v-else
      class="chat-bubble py-0 prose prose-sm bg-white dark:bg-gray-900 dark:text-white text-black max-w-max w-full"
